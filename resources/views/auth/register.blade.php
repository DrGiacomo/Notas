            ...
            <div class="card bg-secondary shadow border-0">
              ...
              <div class="card-body px-lg-5 py-lg-5">
                ...
                <div class="text-center text-muted mb-2">
                    <h4>Se enontro el siguiente error</h4>
                </div>
                ...
                <form role="form" method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-alternative mb-3">
                      ...
                      <input class="form-control" placeholder="Email" type="Correo Electronico"  name="email" value="{{ old('email')}}" required autocomplete="email">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Contraseña" type="password" name="password" name="password" required autocomplete="new-password">
                    </div>
                  </div>    
                    <div class="form-group">
                    <div class="input-group input-group-alternative">
