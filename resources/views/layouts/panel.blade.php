        ...
        <ul class="navbar-nav">
          <li class="nav-item  active ">
            <a class="nav-link  active " href="home">
              <i class="fas fa-cloud"></i> Dashboard
            </a>
          </li>
        </ul>
        <ul>
        ...
        <ul>
          <li class="nav-item">
            <a class="nav-link " href="cursos">
              <i class="fas fa-bookmark"></i> Cursos
            </a>
          </li>
        </ul>
        <ul>
          <li class="nav-item">
            <a class="nav-link " href="profesores">
              <i class="fas fa-user-alt"></i> Profesores
            </a>
          </li>
        </ul>
        <ul>
          ...
          <ul>
            <li class="nav-item">
              ...
              >
                <i class="fas fa-sign-in-alt"></i> Cerrar Seccion
              </a>
              <form action="{{route('logout')}}" method="POST" style="display: none;" id="form">
   @csrf
              </form>
